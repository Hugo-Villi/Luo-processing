...
disc_str=66;   %nombre de niveaux de discrétisations
sweep_str=18;   %taille des sous-ensemble comparés
PeakHeight_str=1;   %réglage de la hauteur minimale
PeakDistance_str=28;    %reglage de la distance minimale entre deux pics
PeakProminence_str=2.6311863261;
...
for ind_folder = 1:size(folder,2)
    ...
    for ind_name = 3:size(name_files)
        ...
        [Reve_r_str,Leve_r_str,Reve_l_str,Leve_l_str]= Luo_motion_extraction_sofa_R_L(...
            acq,set,side,disc_str,sweep_str,PeakHeight_str,PeakDistance_str,PeakProminence_str,1);
