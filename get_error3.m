function [error_strike,error_off,peaks_num] = get_error3(I,labels_events,events_frame,file_for_save,marker_set_choice,side,string1,size_sweep,PeakHeight,PeakDistance,PeakProeminence)
